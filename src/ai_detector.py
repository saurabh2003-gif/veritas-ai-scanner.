...
class AIDetector:
    def __init__(self):
        print("🧠 Initializing Veritas AI Engine (Independent Heatmap Mode)...")
    ...
    def highlight_analysis(self, text):
        ...
        # 1. SYNCHRONIZED TRAP LIST (The Fix)
        # We copy ALL traps here so the Heatmap knows what to paint RED.
        traps = [
